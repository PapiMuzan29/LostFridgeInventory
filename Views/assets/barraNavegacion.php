...
<div class="sidebar">
        ...
        <div class="sidebar-footer">
            <button class="btn-logout" onclick="getElementById('modal-logout').style.display='flex'">
            ...
            <div class="metrics-right-group">
                ...
                <div class="metric-item user-badge">
                    ...
                    <div class="user-info">
                        ...
                        <span class="user-id">
                            <?php echo $_SESSION['apodoUsuario'] ?? 'Usuario'; ?>
                        </span>

                        <span class="user-role">
                            <?php echo $_SESSION['nombreRol'] ?? 'Sin rol'; ?>
                        </span>
